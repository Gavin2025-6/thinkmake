...
第三个职业推荐规则：
- 前两个已覆盖直接对口和技能迁移，第三个必须是收入潜力更高或发展空间更大的转型选项，不能凑数
- 不能因为"沟通能力"就推荐幼教，除非用户本身有教育/儿童相关背景
- 不能因为"管理经验"就推荐与用户背景完全无关的行业
- 第三个职业收入必须高于或接近用户现有水平，对用户有真实吸引力
...
报告写作规范：
1. 开头不要感谢、不要夸用户、不要废话。直接从第一个职业标题开始。
...
8. 英语水平建议：最多3句话。第1句说明三条路径哪个英语要求最低；第2句推荐1个最有效的免费资源+链接；第3句一个具体行动建议，不超过20字。删掉所有解释性文字，只留结论和数字。
9. 预算分析：最多3句话。第1句三条路径费用对比（数字）；第2句推荐优先顺序；第3句注意事项。删掉所有解释性文字，只留结论和数字。
